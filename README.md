[![npm](https://img.shields.io/npm/v/@dramaorg/aspernatur-voluptatibus.svg)](https://www.npmjs.com/package/@dramaorg/aspernatur-voluptatibus) ![downloads](https://img.shields.io/npm/dt/@dramaorg/aspernatur-voluptatibus.svg) [![CI](https://github.com/dramaorg/aspernatur-voluptatibus/actions/workflows/ci.yml/badge.svg)](https://github.com/dramaorg/aspernatur-voluptatibus/actions)
...
- Install by executing `npm install @dramaorg/aspernatur-voluptatibus` or `yarn add @dramaorg/aspernatur-voluptatibus`.
- Import by adding `import DatePicker from '@dramaorg/aspernatur-voluptatibus'`.
...
[Online demo](https://projects.wojtekmaj.pl/@dramaorg/aspernatur-voluptatibus/) is also available!
...
Add React-Date-Picker to your project by executing `npm install @dramaorg/aspernatur-voluptatibus` or `yarn add @dramaorg/aspernatur-voluptatibus`.
...
import DatePicker from '@dramaorg/aspernatur-voluptatibus';
...
```ts
import '@dramaorg/aspernatur-voluptatibus/dist/DatePicker.css';
...
| className            | Class name(s) that will be added along with `"@dramaorg/aspernatur-voluptatibus"` to the main React-Date-Picker `<div>` element.                                                                                                                                                                                                                           | n/a                                   | <ul><li>String: `"class1 class2"`</li><li>Array of strings: `["class1", "class2 class3"]`</li></ul>                                                                                                                 |
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@dramaorg/aspernatur-voluptatibus#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@dramaorg/aspernatur-voluptatibus#sponsors" target="_blank"><img src="https://opencollective.com/@dramaorg/aspernatur-voluptatibus/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@dramaorg/aspernatur-voluptatibus#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@dramaorg/aspernatur-voluptatibus#backers" target="_blank"><img src="https://opencollective.com/@dramaorg/aspernatur-voluptatibus/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@dramaorg/aspernatur-voluptatibus/contributors.svg?width=890&button=false)
